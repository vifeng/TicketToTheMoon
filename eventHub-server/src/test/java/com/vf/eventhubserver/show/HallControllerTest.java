...
class HallControllerTest {
        ...
        public void setUp(WebApplicationContext webApplicationContext,
                ...
                Employee employee = new Employee("username1", "testPassword1&",
        ...
        void createHallForVenueId() throws Exception {
                ...
                Employee employee =
                                new Employee("username2", "testPassword2&", "email2@example.com");
                Set<Employee> employees = new HashSet<>();
                employees.add(employee);
                ...
                ResultActions request = this.mockMvc
                                .perform(post(baseUrl + "venues/{venue_id}/halls", "1")
                ...
                request.andExpect(jsonPath("$.id", is(notNullValue())))
                                ...
                                .andExpect(jsonPath("$.capacityOfHall")
                                                .value(hall.getCapacityOfHall()))
        ...
        void hallGetById() throws Exception {
                ResultActions request = this.mockMvc
                                .perform(get(baseUrl + "halls/{id}", 4L)
                                                .accept(MediaType.APPLICATION_JSON_VALUE))
                                .andExpect(status().isOk());

                request.andReturn().getResponse().getHeader("Location");

                request.andExpect(jsonPath("$.id").value(4))
