...
class EmployeeControllerTest {
        ...
        public void setUp(WebApplicationContext webApplicationContext,
                ...
                Employee employee1 =
                                new Employee(2L, "username1", "secretpwD%1", "email1@mail.com");
                Employee employee2 =
                                new Employee(3L, "username2", "secretpwD%2", "email2@mail.com");
        ...
        void employeesCreate() throws Exception {
                ...
                request.andExpect((null != employee.get("id")) ? jsonPath("$.id", notNullValue())
        ...
        void employeesGet() throws Exception {
                ResultActions request = this.mockMvc.perform(get(baseUrl + "employees"))
                                .andExpect(status().isOk());
                request.andReturn().getResponse().getHeader("Location");
                ConstraintDescriptions desc = new ConstraintDescriptions(Employee.class);

                request.andExpect(jsonPath("$[*].id", is(notNullValue())))
                                .andExpect(jsonPath("$[*].username", is(notNullValue())))
                                .andExpect(jsonPath("$[*].username",
                                                hasItems("username1", "username2")))
        ...
        void employeesGetById() throws Exception {
                ResultActions request = this.mockMvc
                                .perform(get(baseUrl + "employees/{id}", 3L)
        ...
        void employeesPatch() throws Exception {
                ...
                ResultActions request = this.mockMvc
                                .perform(patch(baseUrl + "employees/{id}", 3L)
                                                .accept(MediaType.APPLICATION_JSON_VALUE)
                                                .contentType(MediaTypes.HAL_JSON)
                                                .content(this.objectMapper
                                                                .writeValueAsString(employee)))
                ...
                request.andExpect(jsonPath("$.password", is("secretpwD%666"))).andDo(document(
                                "employees-patch",
                                pathParameters(parameterWithName("id").description(
                                                "The id of the employee to be retrieved"))));
        ...
        void employeesPut() throws Exception {
                ...
                employee.put("email", "mymail@mail.fr");
                ResultActions request = this.mockMvc
                                .perform(put(baseUrl + "employees/{id}", 3L)
                                                .accept(MediaType.APPLICATION_JSON_VALUE)
                                                .contentType(MediaTypes.HAL_JSON)
                                                .content(this.objectMapper
                                                                .writeValueAsString(employee)))
                ...
                request.andExpect(jsonPath("$.username", is("usernamePut1")))
                                .andExpect(jsonPath("$.password", is("secretpwD%1")))
                                .andExpect(jsonPath("$.email", is("mymail@mail.fr")))
                                .andDo(document("employees-put",
                                                pathParameters(parameterWithName("id").description(
                                                                "The id of the employee to be retrieved")),
                                                requestFields(fieldWithPath("id").description(
        ...
        void employeesDelete() throws Exception {
                this.mockMvc.perform(delete(baseUrl + "employees/{id}", 2L)
                                .accept(MediaType.APPLICATION_JSON_VALUE))
                                .andExpect(status().isNoContent())
                                .andDo(document("employees-delete-by-id",
                                                pathParameters(parameterWithName("id").description(
                                                                "The id of the employee to be retrieved"))));
        }
}
