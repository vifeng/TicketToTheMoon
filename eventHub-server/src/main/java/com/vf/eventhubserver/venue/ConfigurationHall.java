...
public class ConfigurationHall implements Serializable {
   ...
   * configuration. exemple: for a Hall of 100, a seated configuration will have a capacity of 50. a
   * standing one will have a capacity of 100.")
   */
  ...
  /**
   * @Description(value = "this method is used to check if the constructor is valid. it is called by
   * the mapper after mapping.")
   */
  public void checkConstructor() {
    ...
    if (hall == null) throw new IllegalArgumentException("hall must not be null - setHall() first");
