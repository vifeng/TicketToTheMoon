...
public class PaymentStatusService {
    ...
    public PaymentStatusDTO findById(Long id) throws FinderException {
        PaymentStatus paymentStatus = paymentStatusRepository.findById(id).orElseThrow(
                () -> new FinderException("PaymentStatus with id {" + id + "} not found"));
    ...
    public PaymentStatusDTO findByPaymentStatusName(String status) throws FinderException {
        PaymentStatus paymentStatus = paymentStatusRepository.findByPaymentStatusName(status)
