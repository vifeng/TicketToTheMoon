...
This is a sample of the documentation for the Event Hub server side. The API is used to manage the following resources : event, ticket, reservation and customer order.
