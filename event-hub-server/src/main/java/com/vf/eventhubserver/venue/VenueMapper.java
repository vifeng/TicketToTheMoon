...
public interface VenueMapper {
  ...
  default AddressDTO toAddressDTO(Venue venue) {
    ...
    if (address == null) throw new IllegalArgumentException("Venue address cannot be null");
    return toAddressDTO(address);
  }

  default Address toAddress(VenueDTO venueDTO) {
    AddressDTO addressDTO = venueDTO.getAddress();
    if (addressDTO == null) throw new IllegalArgumentException("Venue address cannot be null");
  ...
  default Set<EmployeeDTO> toEmployeeDTO(Venue venue) {
    ...
    if (employees == null) throw new IllegalArgumentException("Venue employees cannot be null");
  ...
  default Set<Employee> toEmployee(VenueDTO venueDTO) {
    ...
    if (employeesDTO == null) throw new IllegalArgumentException("Venue employees cannot be null");
