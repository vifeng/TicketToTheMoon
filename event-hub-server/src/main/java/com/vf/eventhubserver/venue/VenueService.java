...
public class VenueService {
  ...
  public VenueDTO findById(Long id) throws FinderException {
    ...
    if (venue == null) throw new NullException(VENUENULLMSG);
  ...
  public VenueDTO patchVenue(Long id, Map<String, Object> venuePatch)
    ...
    try {
            ...
            (key, value) -> {
              if (key != null) {
                if ("address".equals(key)) {
                  ...
                  Set<Employee> employeesPatch = objectMapper.convertValue(value, typeReference);
      ...
      throw new IllegalArgumentException(VEMSG + id + "} patch failed : " + e.getMessage(), e);
    } catch (Exception e) {
  ...
  public VenueDTO removeEmployee(Long id, Long employeeId) throws FinderException, UpdateException {
    try {
      Venue venue =
          venueRepository
              .findById(id)
