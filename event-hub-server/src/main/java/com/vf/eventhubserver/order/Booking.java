...
public class Booking {
  ...
  public Booking(
      Timestamp bookingCreationTimestamp, Customer customer, Set<TicketReservation> reservations) {
    setBookingCreationTimestamp(bookingCreationTimestamp);
    setCustomer(customer);
    setReservations(reservations);
  }
  ...
  public void setReservations(Set<TicketReservation> reservations) {
    ...
    for (TicketReservation reservation : reservations) {
      totalPriceHt +=
          reservation.getId().getSeatId().getCategoryTariff().getTarification().getBasePrice();
    }
  }
