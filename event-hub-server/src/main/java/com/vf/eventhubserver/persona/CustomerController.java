...
public class CustomerController implements LocationResponseBuilder {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<CustomerDTO> getCustomerById(@PathVariable Long id) throws FinderException {
  ...
  public ResponseEntity<CustomerDTO> updateCustomer(
      @PathVariable Long id, @RequestBody CustomerDTO customerUpdateDTO)
  ...
  public ResponseEntity<CustomerDTO> patchCustomer(
      @PathVariable Long id, @RequestBody CustomerDTO customerPatch)
      throws NullException, FinderException, UpdateException, IllegalArgumentException {
