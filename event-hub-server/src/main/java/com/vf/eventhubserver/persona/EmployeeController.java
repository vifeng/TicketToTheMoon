...
public class EmployeeController {
   ...
   */
  @GetMapping("/{id}")
  public ResponseEntity<EmployeeDTO> getEmployeeById(@PathVariable Long id) throws FinderException {
  ...
  public ResponseEntity<EmployeeDTO> patchEmployee(
      @PathVariable Long id, @RequestBody Map<String, Object> employeePatch)
