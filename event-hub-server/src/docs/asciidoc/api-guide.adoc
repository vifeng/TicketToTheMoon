...
Indeed, this API Documentation of RESTful services is done by combining hand-written documentation with auto-generated snippets produced with Spring MVC Test or WebTestClient.
This test-driven approach helps to guarantee the accuracy of your service’s documentation. If a snippet is incorrect, the test that produces it fails.
