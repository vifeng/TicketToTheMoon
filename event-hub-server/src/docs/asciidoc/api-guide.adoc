...
This is a sample of the documentation for the Event Hub server side. The API is used to manage the following resources : order, payment, persona, show, tarification, venue.
